#!/usr/bin/env node
// SAIHM memory for GLM — one client-side-encrypted memory you own; provable forget.
//
//   git clone https://github.com/citw2/demo-glm
//   cd demo-glm && npm install && node demo.mjs
//
// Optional, for a LIVE GLM answer instead of the offline mock:
